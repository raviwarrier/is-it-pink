...
export const MapDataModal: React.FC<MapDataModalProps> = ({
  ...
  // Suggested filename based on Path
  const currentTargetName = libraryPath || 'audiobook-library';
          ...
          <div className="flex items-center gap-2.5">
            ...
            <div>
              ...
              <p className="text-xs text-zinc-400">
                Persistent local storage formatted as <code className="text-zinc-300 font-mono text-[11px] bg-zinc-800 px-1 py-0.5 rounded">[library-name]-data.json</code>
              </p>
            </div>
          </div>
          <button 
              ...
              <div className="space-y-2.5">
                <div className="flex items-center justify-between">
                  <h3 className="text-xs font-bold text-white flex items-center gap-1.5">
                    ...
                    <span>Select Saved Audiobook Map:</span>
                  </h3>
                  <button
                    type="button"
              ...
              <div className="p-4 bg-zinc-900/80 border border-zinc-800 rounded-xl space-y-3">
                ...
                <div className="grid grid-cols-2 sm:grid-cols-3 gap-2 pt-2 border-t border-zinc-800 text-[11px]">
                  ...
                  <div>
                    ...
                    <span className="font-semibold text-zinc-200">Audiobook Library</span>
                  </div>
                  <div>
